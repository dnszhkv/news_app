...
article1 = Post.objects.create(author=author1, type='AR', title='Вспомнить все: как амнезическое кино изгоняет, '
                               ...
                               text='Разговор о кризисе памяти столь же тривиален, как разговор о погоде. И тем не '
                                    ...
                                    'общественных вкусов. Казалось бы, все должно быть наоборот. «Катастрофическое '
                                    ...
                                    'реальность все настоятельнее вписывает человека в историю, еще теснее связывая с '
                                    'прошлым. Перефразируя Диди-Юбермана, можно сказать, что человек есть то, в чем он '
